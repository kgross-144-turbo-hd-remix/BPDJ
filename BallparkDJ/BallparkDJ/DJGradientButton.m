...
@implementation DJGradientButton
...
-(void)viewDidLoad{
    UITapGestureRecognizer* tapGestureRecognizer = [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handle_tap:)] autorelease];
    [self addGestureRecognizer:tapGestureRecognizer];
}

-(void)handle_tap:(UIGestureRecognizer*)gestureRecognizer{
